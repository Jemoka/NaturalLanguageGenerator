...
def treeIfy(taggedSentence):
    ...
    PP:
    {<IN><DT>?<RB>*<JJ>*<PP>*<PRP|PRP$|WP|FW|WP$|NN.*|LS>+}
    {<IN><DT>?<RB>*<JJ>*<PRP|PRP$|WP|WP$|NN.*><CC>*<PRP|PRP$|WP|WP$|NN.*>+}
    {<IN><DT>?<RB>*<JJ>*<PRP|PRP$|WP|WP$|NN.*|LS.*>+ <IN>?}
    {<IN><DT>?<RB>*<JJ>*<PRP|PRP$|WP|WP$|NN.*|LS.*>+ <IN>?}
    {<IN><DT>?<RB>*<JJ>*<LIST>+}
    NP:
    {<DT>?<RB>*<JJ>*<PP>*<PRP|PRP$|WP|WP$|NN.*|LS>+<PP>*}
...
etiquette_excerpt = "On Wednesdays, I ate lunch with Mr. Lera and Micah worked on Spanish."
...
#
# The guests at the governor's dinnfer were introduced and seated according to the strict protocol governing such occations."
